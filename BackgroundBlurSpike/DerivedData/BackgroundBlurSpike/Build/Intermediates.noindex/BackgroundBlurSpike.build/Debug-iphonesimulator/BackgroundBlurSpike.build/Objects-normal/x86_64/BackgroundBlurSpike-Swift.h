...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BackgroundBlurSpike",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19BackgroundBlurSpike11AppDelegate")
...
SWIFT_CLASS("_TtC19BackgroundBlurSpike13SceneDelegate")
...
@property (nonatomic, weak) IBOutlet UIVisualEffectView * _Null_unspecified overlayView;
- (void)viewDidLoad;
